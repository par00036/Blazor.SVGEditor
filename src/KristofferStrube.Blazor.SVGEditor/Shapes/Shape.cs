...
public abstract class Shape : ISVGElement
{
	...
	private void ensureLayer(IElement element)
	{
		var layer = element.GetAttribute("layer");
		if (string.IsNullOrEmpty(layer))
		{
			element.SetAttribute("layer", "0");
		}
	}
	...
	public string Layer
	{
		get => Element.GetAttributeOrEmpty("layer");
		set { Element.SetAttribute("layer", value); Changed?.Invoke(this); }
	}
	public Action<ISVGElement>? Changed { get; set; }
	public bool Selected => SVG.VisibleSelectionShapes.Contains(this);
	public bool IsChildElement => Element.ParentElement is not null;
